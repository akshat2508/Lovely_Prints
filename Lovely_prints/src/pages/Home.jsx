...
const Home = () => {
  ...
  const testimonials = [
    {
      name: "Priya Sharma",
      year: "3rd Year CSE",
      text: "Saved me before my exam. Fast and reliable. No more running to print shops.",
      rating: 5,
    },
    {
      name: "Rahul Kumar",
      year: "2nd Year ECE",
      text: "So much easier than WhatsApp groups. Price comparison is a game changer.",
      rating: 5,
    },
    {
      name: "Ananya Singh",
      year: "4th Year MBA",
      text: "Track my order live? This is exactly what we needed on campus.",
      rating: 5,
    },
    {
      name: "Arjun Patel",
      year: "1st Year ME",
      text: "Got my assignment printed in 10 minutes. Lifesaver during deadline week.",
      rating: 5,
    },
  ];
  ...
  const features = [
    {
      icon: Zap,
      title: "Fast Delivery",
      desc: "Get your prints in 15 mins or less",
    },
    {
      icon: DollarSign,
      title: "Fair Pricing",
      desc: "Compare prices across all shops",
    },
    {
      icon: MapPin,
      title: "Near Campus",
      desc: "12+ shop partners across campus",
    },
    {
      icon: Shield,
      title: "Secure Payment",
      desc: "Safe online payment with Razorpay",
    },
    {
      icon: TrendingUp,
      title: "Track Orders",
      desc: "Live order tracking and updates",
    },
    {
      icon: Smartphone,
      title: "Easy Payment",
      desc: "Pay online, collect hassle-free",
    },
  ];
  ...
  return (
    <div className="homepage">
        ...
        <div className="nav-container">
          ...
          <div className="nav-cta">
            ...
            <button href="#signup" className="btn btn-primary">
              <Link to="/signup">Get Started</Link> <ChevronRight size={18} />
            </button>
          </div>
          <button
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            >
              ...
              <a
                href={"https://drive.google.com/file/d/1aRH_uIfdql97FJyANHE7-CEfjHhdxVH0/view?usp=drive_link"}
                target="_blank"
      ...
      >
        <div
          className={`section-header ${visibleSections.has("howItWorks") ? "visible" : ""}`}
        >
        ...
        <div className="steps-container">
          <div
            className={`step ${visibleSections.has("howItWorks") ? "visible" : ""}`}
          >
            ...
            <p>
              Drop your PDF, select print options, and get instant pricing
              across all campus shops.
            </p>
          </div>
          <div
            className={`step ${visibleSections.has("howItWorks") ? "visible" : ""}`}
          >
            ...
            <h3>Choose Shop</h3>
            <p>
              Pick your nearest campus shop, compare prices, and pay securely
          ...
          >
            ...
            <h3>Collect Print</h3>
            <p>
              Get notified when ready, track your order live, and collect
              hassle-free.
            </p>
          </div>
        </div>
      ...
      <section id="features" ref={sectionRefs.features} className="features">
        <div
          className={`section-header ${visibleSections.has("features") ? "visible" : ""}`}
        >
      ...
      <section id="coverage" ref={sectionRefs.coverage} className="coverage">
        <div className="coverage-container">
          <div
            className={`section-header ${visibleSections.has("coverage") ? "visible" : ""}`}
          >
      ...
      >
        <div
          className={`section-header ${visibleSections.has("testimonials") ? "visible" : ""}`}
        >
      ...
      <section id="stats" ref={sectionRefs.stats} className="stats">
        <div className="stats-grid">
          <div
            className={`stat-item ${visibleSections.has("stats") ? "visible" : ""}`}
          >
      ...
      <section id="cta" ref={sectionRefs.cta} className="final-cta">
        ...
        <p>Join hundreds of students who never wait in line anymore.</p>
      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-brand">
            ...
            <p>
              <bold>support email</bold> : lovelyprintssprt@gmail.com
            </p>
          </div>
        ...
        <div className="footer-bottom">© 2026 Lovely Prints</div>
      </footer>
    </div>
  );
};
